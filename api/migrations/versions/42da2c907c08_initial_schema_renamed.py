"""initial_schema_renamed

Revision ID: 42da2c907c08
Revises: 
Create Date: 2026-03-29 18:54:03.759537
...
def upgrade() -> None:
    ...
    sa.Column('stop_ids_json', sa.JSON(), nullable=True),
